...
type TThrottleAndDebounce = (fn: TFunCallBack, interval?: number) => TFunCallBack;
...
declare module utils {
     ...
     * @param {*} interval 间隔
     */
    const throttle: TThrottleAndDebounce;
     ...
     * @param {*} interval 间隔
     */
    const debounce: TThrottleAndDebounce;
     ...
     * @param {*} interval 间隔
     */
    const throttleD: TThrottleAndDebounce;
     ...
     * 检验数据
     */
    const createdCheckVal: TCheckValFun;
